...
$url = new moodle_url('/local/kopere_trail/edges.php', ['trailid' => $trailid]);
$PAGE->set_context($context);
$PAGE->set_url($url);
$PAGE->set_title(get_string('trailedges', 'local_kopere_trail'));
$PAGE->set_heading(get_string('trailedges', 'local_kopere_trail'));
...
$edges = $repository->get_edges($trailid);
$page = new \local_kopere_trail\output\edge_list_page($trail, $steps, $edges);
